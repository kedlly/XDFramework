...
namespace Framework.Core.DataStruct
{
	...
	{
		internal static string GetResourceString(string key, string param)
		{
			return key + "/" + param;
		}
    ...
    public class Tuple<T1> : IStructuralEquatable, IStructuralComparable, IComparable, ITupleInternal, ITuple {
        ...
        Int32 IStructuralComparable.CompareTo(object other, IComparer comparer) {
            ...
            if (objTuple == null) {
                throw new ArgumentException("ArgumentException_TupleIncorrectType" + this.GetType().ToString() + "other");
            }
    ...
    public class Tuple<T1, T2, T3, T4, T5, T6, T7> : IStructuralEquatable, IStructuralComparable, IComparable, ITupleInternal, ITuple {
        ...
        /// The number of positions in this data structure.
        /// </summary>
        int ITuple.Length { get { return 7; } }
