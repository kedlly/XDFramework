...
namespace Protocal
{
	struct DataPackageTypeInfo : IEquatable<DataPackageTypeInfo>
	{
		...
		public const string MessageNameSpace = "Protocal";
	...
	public static class ProtocalHelper
	{
		public static ProtoBuf.IExtensible Unpack(this DataPackage dataPackage)
		{
			return ProtocalWrapper.DataPackage_Unpack(dataPackage);
		}

		public static DataPackage Pack(this ProtoBuf.IExtensible data)
		{
			return ProtocalWrapper.DataPackage_Pack(data);
		}
