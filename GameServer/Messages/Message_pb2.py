...
_MESSAGEMINORTYPE = _descriptor.EnumDescriptor(
  ...
  full_name='Protocol.Transport.MessageMinorType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_DATAPACKAGE = _descriptor.Descriptor(
  name='DataPackage',
  full_name='Protocol.Transport.DataPackage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='majorType', full_name='Protocol.Transport.DataPackage.majorType', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='minorType', full_name='Protocol.Transport.DataPackage.minorType', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='Protocol.Transport.DataPackage.data', index=2,
...
DataPackage = _reflection.GeneratedProtocolMessageType('DataPackage', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:Protocol.Transport.DataPackage)
  ))
