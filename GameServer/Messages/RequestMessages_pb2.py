...
_REQUEST_MOVING.fields_by_name['movement'].message_type = RawData_dot_InternalData__pb2._MOVEMENTDATA
_REQUEST_ROTATED.fields_by_name['direction'].message_type = RawData_dot_InternalData__pb2._VECTOR3
